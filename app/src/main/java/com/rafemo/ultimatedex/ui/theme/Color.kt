...
val HPColor = Color(0xFF2E7D32)
val AtkColor = Color(0xFFC62828)
val DefColor = Color(0xFFEF6C00)
val SpAtkColor = Color(0xFF6A1B9A)
val SpDefColor = Color(0xFFF9A825)
val SpdColor = Color(0xFF0277BD)
